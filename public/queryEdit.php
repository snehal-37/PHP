...
$sql = "SELECT * FROM `queries` WHERE `queries`.`id` = $id";
        ...
        <div class="row g-2 my-5">
          <div class="col">
            <div class="card w-100">
              <div class="card-header text-center"><h4 class="p-2">Query Details</h4></div>
              <div class="card-body">
                <p class="card-title text-center">Name: <?php echo "{$row['name']}"; ?></p>
                <p class="card-title text-center">Email: <?php echo "{$row['email']}"; ?></p>
                <p class="card-title text-center">Query: <?php echo "{$row['query']}"; ?></p>
                ...
                <label for="" class="form-label" style="color:black">Send to:</label>
                    ...
                    <div class="mb-3">
                    <textarea class="form-control form-little-squirrel-control border border" required name="carea" 
